-- Restaura security_invoker na view (remote_schema dumps omitiam a opção → Security Definer no Studio)
...
-- View é somente leitura; revoga permissões de escrita herdadas de dumps/grants antigos
